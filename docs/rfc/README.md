...
| 0022 | S13 Verification & Conformance Subsystem Specification | G-SPEC(S13), B-08, G-CONF, P12 | S13 | **In Review** — specifies sole judge harness boundary, dual-corpus fixtures, and binary self-certification claim regime (15 proposed clauses `S13#1.1`–`S13#4.4`) |
...
deterministic execution-bundle output emission (`S05#4.x`). Accepted and
recorded by **ADR-0014**; all 13 clauses (`S05#1.1`–`S05#4.3`) ratified
